  ...
  return (
    <section id="certifications" className="py-20 px-6 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">Certifications & Professional Development</h2>
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
          {certifications.map((cert, index) => (
            ...
            >
              <CardHeader>
                <CardTitle className="text-lg text-gray-800">{cert.title}</CardTitle>
